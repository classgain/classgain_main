...
const categoryMap = {
  ...
  'starting-education': { key: 'primary', title: 'Starting Education', path: '/startingeducation' },
  highereducation: { key: 'secondary', title: 'Higher Education', path: '/highereducation' },
  'higher-education': { key: 'secondary', title: 'Higher Education', path: '/highereducation' },
  additionaleducation: { key: 'extra', title: 'Addisnal Education', path: '/additionaleducation' },
  'additional-education': { key: 'extra', title: 'Addisnal Education', path: '/additionaleducation' }
};
