...
const baseSearchItems = [
  { label: 'Main Page', keywords: ['main page', 'home', 'class gain'], to: '/home' },
  { label: 'Starting Education', keywords: ['starting education', 'primary', 'school'], to: '/startingeducation' },
  { label: 'Higher Education', keywords: ['higher education', 'secondary', 'college'], to: '/highereducation' },
  {
    label: 'Additional Education',
    keywords: ['addisnal education', 'additional education', 'extra skills', 'coaching'],
