          ...
          <div className="education-card__detail">
            <span className="education-card__icon" aria-hidden="true">
              <svg viewBox="0 0 24 24">
                ...
                <path d="m6.5 7 5.5 4 5.5-4" />
              </svg>
            </span>
            <a href={`tel:${item.phone || ''}`.trim()}>{item.phone || 'Phone not available'}</a>
          </div>
          <div className="education-card__detail">
            <span className="education-card__icon" aria-hidden="true">
              <svg viewBox="0 0 24 24">
            ...
            <a href={`mailto:${item.contactEmail || ''}`.trim()}>{item.contactEmail || 'Email not available'}</a>
          </div>
